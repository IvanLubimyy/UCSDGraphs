...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		List<Integer> degreeVertices = new ArrayList<Integer>();
		 
		for (int u=getNumVertices(); u > 0; u--) {
				degreeVertices.add(getInNeighbors(u-1).size()+getNeighbors(u-1).size());
		}
		 Collections.sort(degreeVertices);
		 Collections.reverse(degreeVertices);
	...
	public static void main (String[] args) {
		...
		System.out.println(myGraph.degreeSequence());
		System.out.println("7 5 4 4 2 (correct)");
		...
		System.out.println(myGraph.getDistance2(4));
		System.out.println("For 4 must be: 4 1 3 0 3 2 3 0 2");
		System.out.println("****");
		System.out.println(myGraph.getDistance2(1));
		System.out.println("For 1 must be: 0 2 3 1 3");
		System.out.println("****");
		System.out.println(myGraph.getDistance2(2));
		System.out.println("For 2 must be: 3 2 3 2 0");
